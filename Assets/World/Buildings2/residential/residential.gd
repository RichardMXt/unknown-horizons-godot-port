...
func calculate_tax_revenue():
  var tax_rate_per_resident_per_second := GameStats.treasury.gold_per_resident_per_tier_per_second[self.current_tier]
  var tax_revenue = self.residents_count * GameStats.treasury.tax_rate_per_tier[self.current_tier_val] * tax_rate_per_resident_per_second
  return tax_revenue
